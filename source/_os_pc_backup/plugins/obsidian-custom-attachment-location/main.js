...
var require_AttachmentPath = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/AttachmentPath.cjs"(exports2, module2) {
    ...
    async function getAvailablePathForAttachments2(app, filename, extension2, file, skipFolderCreation) {
...
var require_Link = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Link.cjs"(exports2, module2) {
    ...
    function extractLinkFile2(app, link2, notePathOrFile) {
    ...
    function generateMarkdownLink(options) {
      ...
      return (0, import_MetadataCache2.tempRegisterFileAndRun)(app, file, () => {
        ...
        let linkText = file.path === sourcePath && subpath ? subpath : forceRelativePath ? (0, import_Path6.relative)((0, import_Path6.dirname)(sourcePath), isWikilink ? (0, import_FileSystem4.trimMarkdownExtension)(file) : file.path) + subpath : app.metadataCache.fileToLinktext(file, sourcePath, isWikilink) + subpath;
    ...
    function shouldResetAlias(options) {
      ...
      const sourceDir = (0, import_Path6.dirname)(sourcePath);
      ...
      for (const pathOrFile2 of [file.path, ...otherPathOrFiles]) {
        ...
        aliasesToReset.add((0, import_Path6.relative)(sourceDir, path));
      }
    ...
    function updateLink2(options) {
      ...
      const isWikilink = testWikilink(link2.original) && forceMarkdownLinks !== true;
      ...
      if (shouldUpdateFilenameAlias ?? true) {
        if (alias?.toLowerCase() === (0, import_Path6.basename)(oldPath, (0, import_Path6.extname)(oldPath)).toLowerCase()) {
          alias = file.basename;
        } else if (alias?.toLowerCase() === (0, import_Path6.basename)(oldPath).toLowerCase()) {
          alias = file.name;
        }
      }
      if (newPath) {
      ...
      if ((0, import_FileSystem4.isCanvasFile)(sourcePathOrFile)) {
    ...
    async function updateLinksInFile(options) {
      ...
      if ((0, import_FileSystem4.isCanvasFile)(pathOrFile) && !app.internalPlugins.getEnabledPluginById("canvas")) {
        return;
      }
      await editLinks(app, pathOrFile, (link2) => {
    ...
    async function handleRenameAsync(app, oldPath, newPath, backlinks) {
      ...
      try {
        ...
        for (const [oldRelatedPath, newRelatedPath] of renameMap.entries()) {
          ...
          parentFolders.add((0, import_Path6.dirname)(oldRelatedPath));
        }
        const settings = getSettings(app);
        ...
        for (const [newBacklinkPath, linkJsonToPathMap] of backlinksMap.entries()) {
          await (0, import_Link2.editLinks)(app, newBacklinkPath, (link2) => {
            const oldRelatedPath = linkJsonToPathMap.get((0, import_Object2.toJson)(link2));
            if (!oldRelatedPath) {
              return;
            }
