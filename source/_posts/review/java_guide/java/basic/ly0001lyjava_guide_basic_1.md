...
- 字节码，采用字节码的好处
  ...
  - Java程序从源代码到运行的过程
    ![ly-20241129104308040](attachments/img/ly-20241129104308040.png)
...
- 编译与解释并存
  ...
  - 如图
    ![ly-20241129104308411](attachments/img/ly-20241129104308411.png)
...
- 注释分为 单行注释、多行注释、文档注释
  ![ly-20241129104308749](attachments/img/ly-20241129104308749.png)
...
- 包装类型的缓存机制
  ...
  - 如上，所有整型包装类对象之间值的比较，应该全部使用equals方法比较
    ![ly-20241129104309094](attachments/img/ly-20241129104309094.png)
  ...
  - 超过long整形的数据，使用BigInteger
    ...
    ![ly-20241129104309436](attachments/img/ly-20241129104309436.png)