...
- 深拷贝和浅拷贝的区别？什么是引用拷贝
  ...
  - 如图  
    ![ly-20241129104309825](attachments/img/ly-20241129104309825.png)
...
- 字符串使用“+” 还是 Stringbuilder 
  ...
  对应的字节码：  
  ![ly-20241129104310303](attachments/img/ly-20241129104310303.png)
...
- 字符串常量池  
  ...
  - ####  String s1 = new String("abc");这句话创建了几个字符串对象？
    ...
    下面这个解释，说明**常量池存储的是引用**（堆中某一块区域的）![ly-20241129104310649](attachments/img/ly-20241129104310649.png)
