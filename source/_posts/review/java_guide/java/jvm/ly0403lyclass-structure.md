...
![ly-20241129104431916](attachments/img/ly-20241129104431916.png)
...
![ly-20241129104433362](attachments/img/ly-20241129104433362.png)

通过IDEA插件jclasslib查看，可以直观看到```Class 文件结构```

![img](attachments/img/ly-20241129104433700.png)
...
![ly-20241129104434073](attachments/img/ly-20241129104434073.png)
...
1. 字面量比较接近于Java语言层面的**常量概念**，如**文本字符串**、**声明为final的常量值**等
   ...
   > 注意，**非常量**是不会在这里的，
   > ![ly-20241129104434409](attachments/img/ly-20241129104434409.png)
   >
   > 没有找到3 
...
![ly-20241129104434743](attachments/img/ly-20241129104434743.png)
...
【这里好像漏了一个0x0002 ，private 】![ly-20241129104435154](attachments/img/ly-20241129104435154.png)

> ![img](attachments/img/ly-20241129104435600.jpg)
>
...
![查看类的访问标志](attachments/img/ly-20241129104435959.png)
...
- 字段包括**类级变量**以及**实例变量**，但不包括在**方法内部**声明的局部变量
  filed info(字段表)的结构：  
  ![ly-20241129104436394](attachments/img/ly-20241129104436394.png)
  ...
  ![字段的 access\_flag 的取值](attachments/img/ly-20241129104436753.png)
...
- **method_info（方法表的）结构**  
  ![方法表的结构](attachments/img/ly-20241129104437086.png)
  **方法表的 access_flag 取值：**
  ![方法表的 access\_flag 取值](attachments/img/ly-20241129104437425.png)
...
**如上，字段和方法都拥有属性**
属性大概就是这种
![ly-20241129104437765](attachments/img/ly-20241129104437765.png)
