...
- jstat 命令使用格式  
  ...
  ![ly-20241129104448011](attachments/img/ly-20241129104448011.png)
  ...
  ![ly-20241129104448551](attachments/img/ly-20241129104448551.png)

  另外，加上 `-t`参数可以在输出信息上加一个 Timestamp 列，显示程序的运行时间。
  各个参数的含义  
  ![ly-20241129104448994](attachments/img/ly-20241129104448994.png)

## jinfo：实时地查看和调整虚拟机各项参数

`jinfo vmid` :输出当前 jvm 进程的全部参数和系统属性 (第一部分是系统的属性，第二部分是 JVM 的参数)。
如下图： 
![ly-20241129104449374](attachments/img/ly-20241129104449374.png)
![ly-20241129104449778](attachments/img/ly-20241129104449778.png)



![ly-20241129104450171](attachments/img/ly-20241129104450171.png)
...
进入/histo  会发现，有这个东西
![ly-20241129104450517](attachments/img/ly-20241129104450517.png)
...
![连接 Jconsole](attachments/img/ly-20241129104450880.png)
...
1. 在启动方  
   ...
   > ```
   >
   > ![ly-20241129104451219](attachments/img/ly-20241129104451219.png)

2. 注意，虚拟机中（这里ip xxx.200是虚拟机ip），需要开放的端口不只是60001，还要通过 ```netstat -nltp```开放另外两个端口
   ![ly-20241129104451618](attachments/img/ly-20241129104451618.png)
   centos中使用
   ...
   ![ly-20241129104451976](attachments/img/ly-20241129104451976.png)
   ![查看 Java 程序概况 ](attachments/img/ly-20241129104452402.png)
...
![内存监控 ](attachments/img/ly-20241129104452764.png)
...
![线程监控 ](attachments/img/ly-20241129104453117.png)
