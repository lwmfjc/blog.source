...
2. 任务的执行
   ![ly-20241129104352048](attachments/img/ly-20241129104352048.png)
...
![ly-20241129104353349](attachments/img/ly-20241129104353349.png)
...
- ThreadPoolExecutor其他常见参数
  ...
  线程池各个参数的相互关系的理解  
  ![ly-20241129104353708](attachments/img/ly-20241129104353708.png)
...
1. 通过ThreadPoolExecutor构造函数实现（推荐）
   ![ly-20241129104354040](attachments/img/ly-20241129104354040.png)
...
![ly-20241129104354395](attachments/img/ly-20241129104354395.png)
...
图示：  
![ly-20241129104354786](attachments/img/ly-20241129104354786.png)
...
- shutdown() VS shutdownNow()
  ![ly-20241129104355138](attachments/img/ly-20241129104355138.png)
...
1. FixedThreadPool
   ...
   - 执行任务过程介绍
     ...
     ![ly-20241129104355518](attachments/img/ly-20241129104355518.png)
     上图分析
...
2. SingleThreadExecutor
   ...
   - 执行过程
     ![ly-20241129104355909](attachments/img/ly-20241129104355909.png)
...
3. CachedThreadPool
   ...
   ![ly-20241129104356247](attachments/img/ly-20241129104356247.png)
   上图说明：
...
- ScheduleThreadPoolExecutor和Timer的比较
  ![ly-20241129104356616](attachments/img/ly-20241129104356616.png)![ly-20241129104356968](attachments/img/ly-20241129104356968.png)
...
- 运行机制 **//下面这块内容后面更新后原作者删除了**
  ![ly-20241129104357310](attachments/img/ly-20241129104357310.png)
  ...
  ![ly-20241129104357692](attachments/img/ly-20241129104357692.png)
