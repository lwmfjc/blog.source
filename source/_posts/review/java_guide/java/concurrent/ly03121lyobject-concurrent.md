...
- 对象的构成元素（what）
  ...
  ![ly-20241129104411648](attachments/img/ly-20241129104411648.png)
  - 对象头（Header）
    - **对象标记 MarkWord**
...
- 对象标记 
    ...
    ![ly-20241129104412122](attachments/img/ly-20241129104412122.png)

    1. 如果在64位系统中，对象头中，**mark word（对象标记）**占用8个字节（64位）；**class pointer（类元信息）**占用8个字节，总共16字节（忽略压缩指针）
    2. 无锁的时候，
       ![ly-20241129104412462](attachments/img/ly-20241129104412462.png)

- 类型指针
    注意下图，指向方法区中（模板）的地址
    ![ly-20241129104412799](attachments/img/ly-20241129104412799.png)
...
![ly-20241129104413134](attachments/img/ly-20241129104413134.png)

## 具体的（64位虚拟机为主）

![ly-20241129104413471](attachments/img/ly-20241129104413471.png)
...
源码中  
![ly-20241129104413812](attachments/img/ly-20241129104413812.png)
...
- java 运行中添加参数 -XX:MaxTenuringThreshold = 16 ，则会出现下面错误，即分代gc最大年龄为15
  ![ly-20241129104414146](attachments/img/ly-20241129104414146.png)

- 压缩指针的相关说明

  - 使用 java -XX:+PrintComandLineFlags -version ，打印参数

    ![ly-20241129104414482](attachments/img/ly-20241129104414482.png)
