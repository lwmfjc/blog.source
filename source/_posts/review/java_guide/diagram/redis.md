...
1. 主从复制原理  
   ...
   ![主从复制原理](attachments/img/ly-20241129104305754.png)

2. 哨兵模式(简单)  
    ![ly-20241129104306229](attachments/img/ly-20241129104306229.png)
    
3. 哨兵模式详解  
   
   > 先配置**主从模式**，再配置**哨兵模式**
   
    所有的哨兵 sentinel.conf 都是配置为监听master--> 192.168.14.101，如果主机宕机，sentinel.conf 中的配置也会自动更改为选举后的![ly-20241129104306614](attachments/img/ly-20241129104306614.png)
   ...
   1. Java客户端连接原理  
       ...
       ![ly-20241129104306960](attachments/img/ly-20241129104306960.png)
   
   2. 哨兵工作原理  
       主观宕机：sentinel自认为redis不可用  
       客观宕机：sentinel集群认为redis不可用  
       ![ly-20241129104307311](attachments/img/ly-20241129104307311.png)
   
   3. 故障转移  
       ![ly-20241129104307664](attachments/img/ly-20241129104307664.png)
