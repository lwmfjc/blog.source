...
![ly-20241129104238129](attachments/img/ly-20241129104238129.png)

## MySQL基本架构概览

- 下图是MySQL的简要架构图，从下图可以看到**用户的SQL语句**在MySQL内部是**如何执行的**
- 先简单介绍一个下图涉及的一些组件的基本作用
  ![ly-20241129104239341](attachments/img/ly-20241129104239341.png)
...
![ly-20241129104239671](attachments/img/ly-20241129104239671.png)
