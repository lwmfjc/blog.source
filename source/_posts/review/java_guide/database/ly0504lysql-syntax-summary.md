...
#### SQL 语法结构
 ...
 ![img](attachments/img/ly-20241129104213375.jpg) 
...
内部查询首先在其父查询之前执行，以便可以将内部查询的结果传递给外部查询。执行过程可以参考下图：
 ...
 ![img](attachments/img/ly-20241129104214348.jpg) 
...
下图展示了 LEFT JOIN、RIGHT JOIN、INNER JOIN、OUTER JOIN 相关的 7 种用法。
 ...
 ![ly-20241129104214712](attachments/img/ly-20241129104214712.png)
...
- 更改数据格式和表示。
 ...
 ![mysql视图](attachments/img/ly-20241129104215073.jpg) 
...
存储过程可以看成是对一系列 SQL 操作的批处理。存储过程可以由触发器，其他存储过程以及 Java， Python，PHP 等应用程序调用。
 ...
 ![mysql存储过程](attachments/img/ly-20241129104215422.jpg) 
...
![ly-20241129104215879](attachments/img/ly-20241129104215879.png)
