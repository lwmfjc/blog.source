...
![img](attachments/img/ly-20241129104513782.png)

image.png

经过漫长的等待后，代码会全部下载下来，项目结果如下，框起来的就是我们要关注的核心代码了。

![img](attachments/img/ly-20241129104514115.png)

image.png

每个包就是MyBatis的一个模块，每个包的作用如下：

![ly-20241129104514445](attachments/img/ly-20241129104514445.png)
...
![image.png](attachments/img/ly-20241129104514783.png)
