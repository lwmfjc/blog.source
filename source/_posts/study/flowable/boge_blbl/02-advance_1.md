...
- 具体的
  ...
  - 流程历史记录
    ...
    ![ly-20241129104724251](attachments/img/ly-20241129104724251.png)

  - 流程定义表
    ![ly-20241129104724698](attachments/img/ly-20241129104724698.png)

  - 运行实例表
    ![ly-20241129104725044](attachments/img/ly-20241129104725044.png)

  - 用户用户组表

    ![ly-20241129104725380](attachments/img/ly-20241129104725380.png)

- 源码中的体现
  ![ly-20241129104725733](attachments/img/ly-20241129104725733.png)
...
- 把刚才的数据库清空，将flowable的配置文件放到目录custom/lycfg.xml中
  ![ly-20241129104726074](attachments/img/ly-20241129104726074.png)
