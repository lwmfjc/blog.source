...
- 首先绘制流程图（定义）
  ![ly-20241129104738400](attachments/img/ly-20241129104738400.png)

  - 变量处理
    ![ly-20241129104738838](attachments/img/ly-20241129104738838.png)
    ![ly-20241129104739175](attachments/img/ly-20241129104739175.png)
...
- 流程的启动（在流程启动时就已经处理好了各个节点的处理人）
  ...
  - 查看数据库表数据
    ...
    - act_ru_variable
      ...
      ![ly-20241129104739524](attachments/img/ly-20241129104739524.png)![ly-20241129104739855](attachments/img/ly-20241129104739855.png)
    
    - act_ru_task
      ![ly-20241129104740188](attachments/img/ly-20241129104740188.png)
  ...
  - 此时观察task和identity这两张表
    ...
    任务变成了李四，而identity多了张三的记录![ly-20241129104740535](attachments/img/ly-20241129104740535.png)
...
- xml定义中任务监听器的配置(两个节点都配置了)
  ![ly-20241129104740864](attachments/img/ly-20241129104740864.png)
...
- 控制台查看
  ![ly-20241129104741199](attachments/img/ly-20241129104741199.png)

- 数据库查看
  ![ly-20241129104741542](attachments/img/ly-20241129104741542.png)
  ![ly-20241129104741873](attachments/img/ly-20241129104741873.png)
...
- 数据库查看
  ![ly-20241129104742212](attachments/img/ly-20241129104742212.png)
...
- 一个流程定义，可以运行多个流程实例；
  ![ly-20241129104742582](attachments/img/ly-20241129104742582.png)
  ![ly-20241129104742913](attachments/img/ly-20241129104742913.png)
  当用到子流程时，就会出现一对多的关系
  ![ly-20241129104743248](attachments/img/ly-20241129104743248.png)

- 全局变量被重复赋值时后面会覆盖前面

- 流程图的创建
  ![ly-20241129104743588](attachments/img/ly-20241129104743588.png)
...
- 下面修改num的值，修改之前
  ![ly-20241129104743922](attachments/img/ly-20241129104743922.png)
  ...
  - 结果
    ...
    ![ly-20241129104744256](attachments/img/ly-20241129104744256.png)
...
- 局部变量的再次测试
  ...
  - 修改前
    ![ly-20241129104744603](attachments/img/ly-20241129104744603.png)
  - 修改后
    ![ly-20241129104744933](attachments/img/ly-20241129104744933.png)
    - 结果表明这是批量增加/修改，而不是覆盖

- 当前数据库的数据 1个局部变量num，5个全局变量
  ![ly-20241129104745263](attachments/img/ly-20241129104745263.png)
...
- 这时李四设置了一个局部变量num=6
  ...
  仅仅多了一条记录
  ![ly-20241129104745605](attachments/img/ly-20241129104745605.png)
...
- 结果如下，**当局部变量和全局变量的名称一样时，只能修改局部变量**
  ![ly-20241129104745941](attachments/img/ly-20241129104745941.png)
...
- 注意，这里全局变量被改成20了，局部变量被删除了
  ![ly-20241129104746277](attachments/img/ly-20241129104746277.png)
  走到了总经理审批
...
- 再测试
  ...
  现在在赵四节点，局部变量为
  ![ly-20241129104746621](attachments/img/ly-20241129104746621.png)
...
- 现在只能通过在complete中设置，来使得全局变量生效
  ...
  - 结果，全局变量设置成功，且任务流转到了财务那
    ![ly-20241129104746956](attachments/img/ly-20241129104746956.png)
...
- 再测试
  ...
  - 在complete中加上map参数，验证明线条查找的是全局变量的值，complete带上variables会设置全局变量
    ...
    - 数据库表
      ![ly-20241129104747290](attachments/img/ly-20241129104747290.png)
