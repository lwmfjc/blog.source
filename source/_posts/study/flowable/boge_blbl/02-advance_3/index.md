...
- 首先绘制流程图（定义）
  ![ly-20241212142108250](img/ly-20241212142108250.png)

  - 变量处理
    ![ly-20241212142108471](img/ly-20241212142108471.png)
    ![ly-20241212142108572](img/ly-20241212142108572.png)
...
- 流程的启动（在流程启动时就已经处理好了各个节点的处理人）
  ...
  - 查看数据库表数据
    ...
    - act_ru_variable
      ...
      ![ly-20241212142108670](img/ly-20241212142108770.png)
    
    - act_ru_task
      ![ly-20241212142108865](img/ly-20241212142108865.png)
  ...
  - 此时观察task和identity这两张表
    ...
    任务变成了李四，而identity多了张三的记录![ly-20241212142108958](img/ly-20241212142108958.png)
...
- xml定义中任务监听器的配置(两个节点都配置了)
  ![ly-20241212142109052](img/ly-20241212142109052.png)
...
- 控制台查看
  ![ly-20241212142109182](img/ly-20241212142109182.png)

- 数据库查看
  ![ly-20241212142109280](img/ly-20241212142109280.png)
  ![ly-20241212142109374](img/ly-20241212142109374.png)
...
- 数据库查看
  ![ly-20241212142109467](img/ly-20241212142109467.png)
...
- 一个流程定义，可以运行多个流程实例；
  ![ly-20241212142109563](img/ly-20241212142109563.png)
  ![ly-20241212142109660](img/ly-20241212142109660.png)
  当用到子流程时，就会出现一对多的关系
  ![ly-20241212142109758](img/ly-20241212142109758.png)

- 全局变量被重复赋值时后面会覆盖前面

- 流程图的创建
  ![ly-20241212142109851](img/ly-20241212142109851.png)
...
- 下面修改num的值，修改之前
  ![ly-20241212142109944](img/ly-20241212142109944.png)
  ...
  - 结果
    ...
    ![ly-20241212142110039](img/ly-20241212142110039.png)
...
- 局部变量的再次测试
  ...
  - 修改前
    ![ly-20241212142110131](img/ly-20241212142110131.png)
  - 修改后
    ![ly-20241212142110224](img/ly-20241212142110224.png)
    - 结果表明这是批量增加/修改，而不是覆盖

- 当前数据库的数据 1个局部变量num，5个全局变量
  ![ly-20241212142110321](img/ly-20241212142110321.png)
...
- 这时李四设置了一个局部变量num=6
  ...
  仅仅多了一条记录
  ![ly-20241212142110414](img/ly-20241212142110414.png)
...
- 结果如下，**当局部变量和全局变量的名称一样时，只能修改局部变量**
  ![ly-20241212142110508](img/ly-20241212142110508.png)
...
- 注意，这里全局变量被改成20了，局部变量被删除了
  ![ly-20241212142110605](img/ly-20241212142110605.png)
  走到了总经理审批
...
- 再测试
  ...
  现在在赵四节点，局部变量为
  ![ly-20241212142110700](img/ly-20241212142110700.png)
...
- 现在只能通过在complete中设置，来使得全局变量生效
  ...
  - 结果，全局变量设置成功，且任务流转到了财务那
    ![ly-20241212142110798](img/ly-20241212142110798.png)
...
- 再测试
  ...
  - 在complete中加上map参数，验证明线条查找的是全局变量的值，complete带上variables会设置全局变量
    ...
    - 数据库表
      ![ly-20241212142110891](img/ly-20241212142110891.png)
