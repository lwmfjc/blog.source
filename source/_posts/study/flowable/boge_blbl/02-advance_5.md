...
![ly-20241129104753896](attachments/img/ly-20241129104753896.png)

### 排他网关

会按照所有出口顺序流定义的顺序对它们进行计算，选择第一个条件计算为true的顺序流（**当没有设置条件时，认为顺序流为true**）继续流程

![ly-20241129104754373](attachments/img/ly-20241129104754373.png)

- 排他网关的绘制
  ![ly-20241129104754721](attachments/img/ly-20241129104754721.png)
  xml文件
...
- 运行
  ...
  - 数据库
    ![ly-20241129104755062](attachments/img/ly-20241129104755062.png)
...
- 此时再ran一个num为4的实例，然后张三完成，此时会走到总经理审批
  ...
  - 
    ![ly-20241129104755403](attachments/img/ly-20241129104755403.png)

- 注意，如果这里num设置为3，则会报错
  ![ly-20241129104755739](attachments/img/ly-20241129104755739.png)

- 两者区别
  ![ly-20241129104756080](attachments/img/ly-20241129104756080.png)
...
- 绘制流程图
  ![ly-20241129104756418](attachments/img/ly-20241129104756418.png)
...
- 并行网关的条件会被忽略
  ![ly-20241129104756761](attachments/img/ly-20241129104756761.png)
...
- 此时任务停留在zhangsan
  ![ly-20241129104757097](attachments/img/ly-20241129104757097.png)
...
- 查看表数据(一个任务包含多个执行实例)
  ![ly-20241129104757435](attachments/img/ly-20241129104757435.png)

- 让王五和李四进行审批
  查看数据库，wangwu审批后，act_ru_task就少了一条记录
  ![ly-20241129104757772](attachments/img/ly-20241129104757772.png)

- 此时走到总经理节点
  ![ly-20241129104758144](attachments/img/ly-20241129104758144.png)

- 图解
  ![ly-20241129104758482](attachments/img/ly-20241129104758482.png)
...
- 流程图
  ![ly-20241129104758812](attachments/img/ly-20241129104758812.png)
  xml
...
- 看数据，默认走人事和项目经理
  ![ly-20241129104759157](attachments/img/ly-20241129104759157.png)

- i1,i2所在任务执行完后，会发现走总经理
  i1走完之后
  ![ly-20241129104759498](attachments/img/ly-20241129104759498.png)
...
![ly-20241129104759835](attachments/img/ly-20241129104759835.png)
