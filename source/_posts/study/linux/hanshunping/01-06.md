...
## 基础介绍  
* 本套课程内容   
  ![](attachments/img/ly-20241129104844840.png)
...
![](attachments/img/ly-20241129104845214.png)
...
* Linux和Unix关系  
![](attachments/img/ly-20241129104845556.png)
## VMWare安装Centos7.6
在windows中安装Linux系统  
* VM和Linux系统在pc中的关系  
![](attachments/img/ly-20241129104845899.png)
* 安装过程中，网络模式使用NAT模式
* 选择最小安装，且选择CompatibilityLibraries和DevelopmentTools  
![](attachments/img/ly-20241129104846229.png)
* linux分区  
一般分为三个  
![](attachments/img/ly-20241129104846569.png)  
一般boot1G,swap分区一般跟内存大小一致，这里是2G，所以根分区就是剩下的，也就是20-1-2=17G  
如图，boot，/，swap都是标准分区。且boot和/是ext4的文件格式，swap是swap的文件格式  
![](attachments/img/ly-20241129104846902.png)  
* 修改主机名  
![](attachments/img/ly-20241129104847236.png)
* 修改密码及增加除root外的普通用户
* 修改网络为固定ip(NAT模式下)
  * 先在VM里面把子网ip改了，这里改成
  192.168.200.0  
  ![](attachments/img/ly-20241129104847582.png)
  * 然后改网关为192.168.200.200  
  ![](attachments/img/ly-20241129104847923.png)
