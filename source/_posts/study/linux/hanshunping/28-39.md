...
- ln指令
  ...
  ![ly-20241129104913286](attachments/img/ly-20241129104913286.png)

  - 此时cd myroot，就会进入root文件夹
  - 使用rm -f 删除软连接
  - 动态链接库
    ![ly-20241129104913740](attachments/img/ly-20241129104913740.png)

- history 查看曾经执行过的命令
  ![ly-20241129104914121](attachments/img/ly-20241129104914121.png)

- ! + 数字，执行曾经执行过的指令
  ![ly-20241129104914463](attachments/img/ly-20241129104914463.png)

## 时间日期

- date指令-- 显示当前日期
  - date 
    ![ly-20241129104914798](attachments/img/ly-20241129104914798.png)
  - date +%Y 年份
  - date +%m 月份
  - date +%d 哪一天
...
- find /home -name hello.txt   在/home目录下，按名字查找hello.txt
  ![ly-20241129104915132](attachments/img/ly-20241129104915132.png)

- find /home -user tom  按拥有者查找

- find / -size -10M | more   查找小于10M的文件
  ![ly-20241129104915519](attachments/img/ly-20241129104915519.png)

- ls -lh    (h,以更符合人类查看的的方式显示)
  ![ly-20241129104915855](attachments/img/ly-20241129104915855.png)

- locate 搜索文件 （locate之前要使用updatedb指令创建）
  (先使用yum install -y mlocate 进行安装)

- 进行查找
  ![ly-20241129104916193](attachments/img/ly-20241129104916193.png)

- which ls   查看ls在哪个目录下
  ![ly-20241129104916535](attachments/img/ly-20241129104916535.png)

- grep 过滤查找，管道符，"|" 表示将前一个命令的处理结果输出传递给后面的命令处理

  cat /etc/profile | grep 22 -n -i 
  ![ly-20241129104916867](attachments/img/ly-20241129104916867.png)
...
- 使用gzip 和 gunzip
  ![ly-20241129104917204](attachments/img/ly-20241129104917204.png)
- tar 用来压缩或者解压
  压缩后的格式 .tar.gz
- 选项说明
  - -c 产生.tar打包文件
