...
- 创建一个spring boot工程（使用maven）
  ...
  - 使用mybats-x插件自动生成代码
    ...
    - 操作
      ...
      ![](attachments/img/ly-20241129105025768.png)
      ![ly-20241129105026218](attachments/img/ly-20241129105026218.png)
    ...
    - 测试
      ![ly-20241129105026568](attachments/img/ly-20241129105026568.png)
  
  - 使用mybatis-x 插件（idea）
  
  
  
    ![ly-20241129105026904](attachments/img/ly-20241129105026904.png)
    ![ly-20241129105027240](attachments/img/ly-20241129105027240.png)
  
    ![ly-20241129105027579](attachments/img/ly-20241129105027579.png)
