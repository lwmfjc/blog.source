...
- 场景
  ![ly-20241129105019714](attachments/img/ly-20241129105019714.png)

- 乐观锁根据版本号使用 version

- 乐观锁实现流程
  ![ly-20241129105020170](attachments/img/ly-20241129105020170.png)
...
- 数据库数据
  ![ly-20241129105020560](attachments/img/ly-20241129105020560.png)
...
- 数据库增加一个sex 字段，实体类增加一个sex属性
  ![ly-20241129105020896](attachments/img/ly-20241129105020896.png)
...
{% post_link study/mybatis_plus/official/hello  在28%进度的地方 %}
  ...
  - mybatis-plus 代码自动生成
    ...
    - 在测试类中编写程序让其自动生成
      ...
      - shang gui gu 配置
        ![ly-20241129105021234](attachments/img/ly-20241129105021234.png)
      
      ![ly-20241129105021574](attachments/img/ly-20241129105021574.png)
...
- 新建一个mybatis-plus数据库和表
  ![ly-20241129105021945](attachments/img/ly-20241129105021945.png)
...
- 代码
  ...
  - 结构
    ![ly-20241129105022313](attachments/img/ly-20241129105022313.png)
    ![ly-20241129105022661](attachments/img/ly-20241129105022661.png)

## 安装MyBatisX插件

- 插件市场
  ![ly-20241129105022998](attachments/img/ly-20241129105022998.png)
- 自动定位
  ![ly-20241129105023336](attachments/img/ly-20241129105023336.png)

## MyBatis代码快速生成

- 配置
  ![ly-20241129105023674](attachments/img/ly-20241129105023674.png)
- url及密码配置
  ![ly-20241129105024046](attachments/img/ly-20241129105024046.png)
- 使用
  ![ly-20241129105024382](attachments/img/ly-20241129105024382.png)
- ![ly-20241129105024729](attachments/img/ly-20241129105024729.png)
- 自动生成
  ![ly-20241129105025068](attachments/img/ly-20241129105025068.png)
- ![ly-20241129105025410](attachments/img/ly-20241129105025410.png)
