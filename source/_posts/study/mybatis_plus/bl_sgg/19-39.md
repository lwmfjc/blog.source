...
- 水平分表相对垂直分表，会引入更多的复杂性，比如要求唯一的数据id该怎么处理
  ...
  - 核心思想
    ![ly-20241129105016731](attachments/img/ly-20241129105016731.png)
  - 
...
- 逻辑删除(主要是允许数据的恢复)
  ...
  ![ly-20241129105017233](attachments/img/ly-20241129105017233.png)
  ...
  - 逻辑删除
    ...
    - 结果
      ![ly-20241129105017578](attachments/img/ly-20241129105017578.png)

## 条件构造器

- 结构
  ![ly-20241129105017914](attachments/img/ly-20241129105017914.png)

  - 解释
    ![ly-20241129105018297](attachments/img/ly-20241129105018297.png)
...
- Wrapper条件组装
  ![ly-20241129105018646](attachments/img/ly-20241129105018646.png)
  ...
  - 注意 or也有优先级的参数
    ![ly-20241129105018977](attachments/img/ly-20241129105018977.png)
...
- 子查询
  假设需要完整下面的sql查询
  ![ly-20241129105019347](attachments/img/ly-20241129105019347.png)
