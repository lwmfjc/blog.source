...
![](attachments/img/ly-20241129105115737.png)  
### 列表 (List)  
* 单键多值  
* 底层是双向链表  
* 从左放 
  ...
  ```
* lpush:  
![](attachments/img/ly-20241129105116193.png)  
* 从右放  
  ``` 
  rpush k2 v1 v2 v3 
  ```
* brpush:  
![](attachments/img/ly-20241129105116540.png)  
* lpop/rpop  
  ``` 
  lpop k2 #从左边弹出一个值
...
* linsert 
  ...
  ```
  ![](attachments/img/ly-20241129105116875.png)
* lrem,lset
  ``` 
...
![](attachments/img/ly-20241129105117212.png)
### 集合(Set)
* 特点：无序，不重复  
...
![](attachments/img/ly-20241129105117564.png)  
* 常用命令
  ``` 
...
* zset底层数据结构
  * hash结构  
  ![](attachments/img/ly-20241129105117904.png)
  * 跳跃表
  给元素value排序，根据score的范围获取元素列表
  * 对比有序链表和跳跃表  
    * 查找51元素  
    ![](attachments/img/ly-20241129105118230.png)
    * 跳跃表  
    按图中的顺序查找，查找四次就能找到  
    ![](attachments/img/ly-20241129105118574.png)
* End